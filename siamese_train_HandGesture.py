...
def loadData(dataDir,trainCsi,trainLab, testCsi, testLab):
    ...
    train_l = mat2Npy(trainCsi_l, 'Csi_l')
...
class data_gen:
    ...
    def load_data_batch(self,trainCsi_l,trainCsi_r,trainLab):
        ...
        X_l,X_r,y = trainCsi_l,trainCsi_r,trainLab
        X_l,X_r,y = shuffle(X_l,X_r,y, random_state=0)
        ...
        while(True):
            ...
            for i in range(int(train_len/load_batch)):
                ...
                X_trainl, X_trainr, y_t = shuffle(X_trainl, X_trainr, y_t, random_state=0)
        ...
        for i in range(self.start,100000):
            ...
            if i % 500 == 0:
                ...
                if val_acc > self.best_acc:
                    ...
                    self.model.save_weights("siamese_best_model/best_model.h5".format(i,val_acc))    
                ...
                # print('prob:',prob)
                #
                print('Iteration :{}  lr :{:.8f} momentum :{:.6f} batch_size:{} load_batch:{} avg_acc: {:.4f} val_acc :{:.2f} % time_taken {:.2f} s'.format(i, K.get_value(self.model.optimizer.learning_rate), K.get_value(self.model.optimizer.momentum),batch_size, load_batch, train_acc, val_acc, end_time - start_time))
                train_loss, train_acc = [],[]
