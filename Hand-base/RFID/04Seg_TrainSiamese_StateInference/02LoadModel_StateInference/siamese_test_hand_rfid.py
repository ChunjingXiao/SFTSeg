...
parser.add_argument('--csiFile',   dest='csiFile', default='RFID1_30data5_1.mat', help='CSI data File Name')
...
class siamese_network():
    ...
    def test_pairs(self, testCsi_l, testCsi_r, n_way=48):
         ...
         siamese_predict_ema = open(args.outputDir + '/'+args.testCsi.replace(".mat", "") + args.csiFile.replace(".mat", "") + "_predict_ema", "a")
