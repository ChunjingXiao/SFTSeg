clear
    actionNum=11; %%一个文件中的动作数量
    seg_threshold= 16;         %%%参考DeepSeg的1秒50个包    Handgesture 32HZ     RFID0.5s
dataDir = ['E:\AWIFI_Segment2020\ESPRESSO_DataPreprocess\00BlendData\SFT-Seg-upload\wifi_base\HandGesture\05Calulate_RMSE'];
...
function countFscore(dataDir,actionNum,seg_threshold)
    ...
    for x=1:numberFilesPre
        ...
        fieldStart=strfind(fileNamePredict,'Hand_');
